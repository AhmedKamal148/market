            ...
            <div class="create_user card card-primary  card-outline">
                ...
                <form action="{{route('admin.user.update' , $user)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="form-group">
                            <img src="{{asset($user->imageUrl)}}" id="image_preview" class="img-thumbnail"
                                 width="100px"/>
                        </div>
                                                            ...
                                                            @if($user->haspermission("create_$model"))
                                                                <input type="checkbox" name="permissions[]"
                                                                   ...
                                                                   custom-control-input-primary"
                                                                       id="createSwitch1{{$model}}" checked/>
                                                            @else
                                                                <input type="checkbox" name="permissions[]"
                                                                       value="create_{{$model}}" class="custom-control-input
                                                                   custom-control-input-primary"
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            @if($user->haspermission("update_$model"))
                                                                ...
                                                                custom-control-input-success"
                                                                       id="updateSwitch3{{$model}}" checked/>
                                                            @else
                                                                <input type="checkbox" name="permissions[]"
                                                                       value="update_{{$model}}" class="custom-control-input
                                                                custom-control-input-success"
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            @if($user->haspermission("delete_$model"))
                                                                ...
                                                                custom-control-input-danger"
                                                                       id="deleteSwitch4{{$model}}" checked/>
                                                            @else
                                                                <input type="checkbox" name="permissions[]"
                                                                       value="delete_{{$model}}" class="custom-control-input
                                                                custom-control-input-danger"
