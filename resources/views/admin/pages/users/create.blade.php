                ...
                <form action="{{route('admin.user.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body ">
                        <div class="form-group">
                            ...
                            <input name="first_name" required type="text" class="form-control" id="firstName"
                                   placeholder="First Name">
                        </div>
                        <div class="form-group">
                            <label for="lastName">Last Name</label>
                            <input name="last_name" required type="text" class="form-control" id="lastName"
                        ...
                        {{--Preview Image--}}
                        <div class="form-group">
                            <img src="{{asset('images/user/default.jpg')}}" id="image_preview" class="img-thumbnail"
                                 width="100px"/>
                        </div>
                                            ...
                                            <ul class="list-unstyled ml-1">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" name="permissions[]"
                                                                   value="create_{{$model}}" class="custom-control-input
                                                ...
                                                <li>
                                                    <div class="form-group">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" name="permissions[]"
                                                                   value="read_{{$model}}" class="custom-control-input
                                                ...
                                                <li>
                                                    <div class="form-group">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" name="permissions[]"
                                                                   value="update_{{$model}}" class="custom-control-input
                                                ...
                                                <li>
                                                    <div class="form-group">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" name="permissions[]"
                                                                   value="delete_{{$model}}" class="custom-control-input
